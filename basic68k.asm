...
;LAB_sizok
	...
	MOVE.l	#ram_addr+ram_base,sp	; set stack to RAM start + 1k
...
LAB_1491
	...
	MOVE.l	#ram_addr+ram_base,sp	; set stack to RAM start + 1k, flush stack
...
; don't check fit if terminal width byte is zero
	...
	BCC		LAB_185E				; branch if less than terminal width
...
LAB_2831
	...
	MOVE.l	d1,-(sp)				; save d1
	MOVE.b		#$A0,d1				; set for no floating bits
...
LAB_INT
	MOVE.b		#$A0,d0				; set for no floating bits
	SUB.b		FAC1_e(a3),d0			; subtract FAC1 exponent
...
LAB_ATLE
	MOVE.l	FAC1_m(a3),d0			; get FAC1 mantissa
	MOVE.b		#$82,d1				; set to correct exponent
...
LAB_RAM
	LEA		ram_base,a0			; get start of EhBASIC RAM
